  ...
  <div class="panel-body text-center" style="overflow-x:auto;">
        ...
        <tbody class="text-center">
            <tr>
                ...
                <td><input type="text" value="" required name="txt-id"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">APELLIDOS</td>
                <td><input type="text" value="" name="txt-apellidos"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;"> NOMBRES</td>
                <td><input type="text" value="" name="txt-nombres"></input></td>
            </tr>
            
            <tr>
                <td class="" style="font-weight:bold;">CFP</td>
                <td><input type="text" value="" name="txt-cfp"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">SEMESTRE</td>
                <td><input type="text" id="semestre-id"value="2018-01" name="txt-semestre" readonly ></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">CICLO</td>
                <td><input type="text" value="" name="txt-ciclo"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">BLOQUE</td>
                <td><input type="text" value="" name="txt-bloque"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">CARRERA</td>
                <td><input type="text" value=" " name="txt-carrera"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">DIA DE CLASE</td>
                <td><input type="text" value="" name="txt-diaclase"></input></td>
            </tr>
               <tr>
                <td class="" style="font-weight:bold;">TELEFONO</td>
                <td><input type="text" value="" name="txt-telefono"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">CELULAR</td>
                <td><input type="text" value="" name="txt-celular"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">EMAIL</td>
                <td><input type="text" value="" name="txt-email"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">DOMICILIO</td>
                <td><input type="text" value="" name="txt-domicilio"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">HORARIO DE PRACTICAS</td>
                <td><input type="text" value="" name="txt-horario"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">PUESTO</td>
                <td><input type="text" value="" name="txt-puesto"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">EMPRESA_PATROCINIO</td>
                <td><input type="text" value="" name="txt-empresa"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">INICIO DE SEMINARIO</td>
                <td><input type="text" value="" name="txt-iniciosem"></input></td>
            </tr>
            <tr>
                <td class="" style="font-weight:bold;">FIN DE SEMINARIO</td>
                <td><input type="text" value="" name="txt-finsem"></input></td>
            </tr>
            <tr>
